...
;(function($){
    var Caroursel1 = function (caroursel){
        var self = this;
        ...
        curPositions1 = this.curPositions;
    ...
    Caroursel1.init = function (caroursels){
        caroursels.each(function(index,item){
            new Caroursel1($(this));
        })  ;
    };
    window["Caroursel1"] = Caroursel1;
...
(function($){
    var Caroursel2 = function (caroursel){
        var self = this;
        this.caroursel = caroursel;
        this.posterList = caroursel.find(".poster-list");
        this.posterItems = caroursel.find(".poster-item");
    ...
    Caroursel2.init = function (caroursels){
        caroursels.each(function(index,item){
            new Caroursel2($(this));
        })  ;
    };
    window["Caroursel2"] = Caroursel2;
